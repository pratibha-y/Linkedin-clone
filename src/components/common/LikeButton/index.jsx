...
export default function LikeButton({ userId, postId, currentUser }) {
  ...
  const addComment = () => {
    ...
    postComment(postId, comment, getCurrentTimeStamp("LLL"), currentUser?.name, currentUser?.imageLink);
            ...
            comments.map((comment) => {
              return (
                <div className="all-comments">
                  ...
                  <img className="comment-profile" src={comment.imageLink} alt="user"></img>
